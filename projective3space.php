...
<div class="pi-row-block pi-row-block-logo">
	<a href="index.php"><img src="images/finite.png" alt=""></a>
</div>
<!-- End logo -->
...
<div class="pi-section-w pi-section-white piTabs">
	<div class="pi-section" style="padding: 10px 0">
		...
		<ul class="pi-tabs-navigation pi-responsive-sm" id="myTabs">
			<li class="pi-active"><a href="#Elements"><i class="icon-users"></i>Points<br> </a></li>
			<li><a href="#AdditionTable"><i class="icon-cog"></i>Lines</a></li>
			<li><a href="#MultiplicationTable"><i class="icon-thumbs-up"></i> Incidence between <br>points and lines</a></li>
			<li><a href="#MultiplicationTable"><i class="icon-thumbs-up"></i> Incidence between <br>points and planes</a></li>
			<li><a href="#MultiplicationTable"><i class="icon-thumbs-up"></i> Incidence between <br>lines and planes</a></li>
		</ul>

<div class="pi-tabs-content pi-tabs-content-shadow">
			
			<!-- Tabs content item -->
			<div class="pi-tab-pane pi-active" id="Elements">
			
				<div class="pi-img-w pi-img-round-corners pi-shadow-effect4 pi-img-left" style="width: 160px;">
					Elements
				</div>
			...
			<div class="pi-tab-pane" id="AdditionTable">
			...
			<div class="pi-tab-pane" id="MultiplicationTable">
...
<div class="pi-section-w pi-shadow-inside-top pi-section-grey">
	...
	<div class="pi-section">
		...
		<p class="lead-16 pi-text-center">
			To be aware of new results about projective 3-sapce
		
		<!-- Forms -->
		<form class="pi-search-form-wide pi-text-center pi-margin-bottom-20" role="form">
			<div class="pi-input-inline" style="margin-right: 10px; width: 360px;">
				<input type="text" class="form-control input-lg pi-input-wide" id="exampleInputSubscribe" placeholder="Enter email address">
			</div>
